...
**Next after Phase 7 smoke:** Phase 8 mode-switch planning behind explicit product approval, or raw-mode product hardening. Do not enable Settings waste-model control or switch live company policy without approval.
