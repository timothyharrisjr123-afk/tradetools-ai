...
**Next after Phase 3:** Phase 4 — DB CHECK widening apply only after explicit SQL approval, then Phase 5 draft refresh/snapshot/staleness dual-mode. Do **not** enable UI, wire production resolver, or select `raw_plus_waste` for live companies until those gates.
