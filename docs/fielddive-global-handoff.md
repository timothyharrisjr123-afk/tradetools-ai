...
**Next after Phase 7:** Controlled raw smoke using non-null coverage/waste values, **or** Phase 8 mode-switch planning behind explicit product approval. Do not enable Settings waste-model control or switch live company policy without approval.
