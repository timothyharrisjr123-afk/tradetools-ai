...
**Next after Phase 2:** Phase 3 — policy/app validator staging + migration **draft** for CHECK widening, still behind an explicit SQL/apply gate. Do **not** enable `raw_plus_waste` in live company policy, widen live DB CHECKs, wire the production resolver, or add Coverage/Waste UI.
