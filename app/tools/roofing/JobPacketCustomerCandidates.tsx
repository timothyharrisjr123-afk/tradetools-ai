...
export function JobPacketCustomerCandidates({
  ...
  const { visible, hiddenCount } = partitionCustomerCandidates(candidates, expanded);
    ...
    <div className="mt-1.5 space-y-1" data-testid="customer-candidates">
      ...
      {hiddenCount > 0 ? (
        <button
          ...
          className="min-h-[28px] px-0.5 text-[11px] font-medium text-slate-600 underline-offset-2 hover:text-slate-800 hover:underline"
        >
          Show more
        </button>
      ) : null}
